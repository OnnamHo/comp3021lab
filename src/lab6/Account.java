...
public class Account {
	...
	// TODO: Task3 
	// replace the null with a lambda expression
	public static AddMaker maker = (int m)-> {Consumer<Account> addN = (a)->{a.balance += m;};
	return addN;};
	...
	public static int getMaxAccountID(List<Account> accounts) {
		// TODO: Task4 
		// replace the null with a lambda expression
		Account maxOne = accounts.stream().reduce(new Account(0, -100), (a, b)->{return a.balance > b.balance ? a: b;});
		return maxOne.id;
	}
